...
export default function TextArea({ canWrite, numLetters, handleSource, translatedText, originalText }) {
	...
	return (
		<>
			<div className='input-area'>
				...
				{numLetters === true && <p className='num-letters'>{originalText}/500</p>}
